...
export default function HotelSubscription() {
	...
	async function handleSubmit(e: any) {
		...
		try {
			const response = await fetch('http://192.168.1.206:3000/api/eatofy/hotel_subscription/add', {
				method: 'POST',
				headers: {
	...
	return (
		<>
			<SideNav />
			<section className="ml-[80px] bg-white flex justify-center items-center h-dvh">
