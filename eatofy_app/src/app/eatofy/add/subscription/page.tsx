...
export default function Subscription() {
	...
	async function handleSubmit(e: any) {
		e.preventDefault();
		try {
			const response = await fetch('http://192.168.1.206:3000/api/eatofy/subscription/add', {
				method: 'POST',
				headers: {
	...
	return (
		<>
			<SideNav />
			<section className="ml-[80px] flex bg-white justify-center items-center h-dvh">
